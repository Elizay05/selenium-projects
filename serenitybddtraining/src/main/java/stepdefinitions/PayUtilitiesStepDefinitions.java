...
public class PayUtilitiesStepDefinitions {
    @Given("Pedro es el cliente del banco")
    public void pedro_es_el_cliente_del_banco() {
    ...
    @When("el intenta realizar el pago del servicio")
    public void el_intenta_realizar_el_pago_del_servicio() {
    }
